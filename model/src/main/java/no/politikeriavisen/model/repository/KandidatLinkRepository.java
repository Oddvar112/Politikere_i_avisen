...
public interface KandidatLinkRepository extends JpaRepository<KandidatLink, Long> {
    ...
    @Query(value = "SELECT ks.navn, "
            ...
            + "GROUP_CONCAT(IFNULL(kl.gir_noytral_score, '') ORDER BY kl.link SEPARATOR ',') as alle_gir_noytral, "
            ...
            + "GROUP_CONCAT(IFNULL(kl.faar_noytral_score, '') ORDER BY kl.link SEPARATOR ',') as alle_faar_noytral "
